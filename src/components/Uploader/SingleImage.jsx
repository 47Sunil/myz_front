...
const SingleImage = ({ getLink }) => {
  ...
  return (
    <div className='flex gap-2 items-center justify-center'>
      <div
        {...getRootProps()}
        className='relative grid h-24 grid-cols-10 gap-3 w-full border-2 border-gray-300/40 border-dashed rounded-lg  items-center justify-center bg-[#2A2439] text-xs text-white/60 p-3'
      >
