...
export const CountryTables = ({ heading }) => {
  ...
  return (
    <div className='w-full h-full bg-[#1E222D] gap-[20px] rounded-2xl max-h-[24rem] pt-8 max-w-[570px] flex  items-center flex-col shadow-[inset_3px_3px_25px_#2d333d] border border-solid border-[#909094] overflow-y-scroll'>
